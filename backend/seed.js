...
const ROLE_DEFS = [
  ...
  },
  {
    ...
    permissions: [
      ...
      'sales.create', 'sales.read', 'sales.cancel', 'sales.delete',
      'orders.create', 'orders.read', 'orders.update', 'orders.cancel', 'orders.pay', 'orders.delete',
      'onDemand.create', 'onDemand.read', 'onDemand.cancel', 'onDemand.pay', 'onDemand.delete',
      'payments.create', 'payments.read',
      'loans.create', 'loans.read', 'loans.update', 'loans.cancel', 'loans.delete',
  ...
  },
  {
    ...
    permissions: [
      ...
      'orders.create', 'orders.read', 'orders.pay',
      'onDemand.create', 'onDemand.read',
      'payments.create', 'payments.read',
